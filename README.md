...
> **Status:** public OSS **v0.9.x** (pre-1.0). Memory M2/M3 + multi-tenant headers + dual-write/metering + Health/Ready/WaitReady + catalog plane + EvaluatePolicy aligned with [iomesh-tui](https://github.com/iome-sh/iomesh-tui).  
...
```go
fmt.Println(iomeshclient.Version) // e.g. "0.9.0"
// All requests send: User-Agent: iomesh-client-sdk-go/0.9.0
