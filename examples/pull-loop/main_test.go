...
func TestFormatPullLoopSummary(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			strict:            false,
			version:           "0.51.0",
			want:              "SUMMARY version=0.51.0 user_agent= base_url= tenant= org= workspace= stream= consumer= cycles_completed=0 fetch_total=0 duration_ms=0 wait_ready_ms=0 wait_interval_ms=0 wait_require_health=false wait_ready_attempts=0 failed=false strict=false result=ok exit_code=0",
		},
		{
			...
			strict:            false,
			version:           "0.51.0",
			want:              "SUMMARY version=0.51.0 user_agent= base_url= tenant= org= workspace= stream= consumer= cycles_completed=3 fetch_total=12 duration_ms=4500 wait_ready_ms=0 wait_interval_ms=0 wait_require_health=false wait_ready_attempts=0 failed=false strict=false result=ok exit_code=0",
		},
		{
			...
			strict:            false,
			version:           "0.51.0",
			want:              "SUMMARY version=0.51.0 user_agent= base_url= tenant= org= workspace= stream= consumer= cycles_completed=1 fetch_total=0 duration_ms=2001 wait_ready_ms=0 wait_interval_ms=0 wait_require_health=false wait_ready_attempts=0 failed=false strict=false result=ok exit_code=0",
		},
		{
			...
			strict:            false,
			version:           "0.51.0",
			want:              "SUMMARY version=0.51.0 user_agent= base_url= tenant= org= workspace= stream= consumer= cycles_completed=1 fetch_total=5 duration_ms=0 wait_ready_ms=0 wait_interval_ms=0 wait_require_health=false wait_ready_attempts=0 failed=false strict=false result=ok exit_code=0",
		},
		{
			...
			strict:            false,
			version:           "0.51.0",
			want:              "SUMMARY version=0.51.0 user_agent= base_url= tenant= org= workspace= stream= consumer= cycles_completed=2 fetch_total=8 duration_ms=1200 wait_ready_ms=5000 wait_interval_ms=500 wait_require_health=false wait_ready_attempts=1 failed=false strict=false result=ok exit_code=0",
		},
		{
			...
			strict:            false,
			version:           "0.51.0",
			want:              "SUMMARY version=0.51.0 user_agent= base_url= tenant= org= workspace= stream= consumer= cycles_completed=1 fetch_total=3 duration_ms=900 wait_ready_ms=3000 wait_interval_ms=250 wait_require_health=true wait_ready_attempts=4 failed=false strict=false result=ok exit_code=0",
		},
		{
			...
			strict:            false,
			version:           "0.51.0",
			want:              "SUMMARY version=0.51.0 user_agent= base_url= tenant= org= workspace= stream= consumer= cycles_completed=0 fetch_total=0 duration_ms=50 wait_ready_ms=100 wait_interval_ms=1 wait_require_health=true wait_ready_attempts=2 failed=false strict=false result=ok exit_code=0",
		},
		{
			...
			strict:            false,
			version:           "0.51.0",
			want:              "SUMMARY version=0.51.0 user_agent= base_url= tenant= org= workspace= stream= consumer= cycles_completed=1 fetch_total=1 duration_ms=10 wait_ready_ms=0 wait_interval_ms=0 wait_require_health=false wait_ready_attempts=0 failed=false strict=false result=ok exit_code=0",
		},
		{
			...
			strict:            false,
			version:           "0.51.0",
			want:              "SUMMARY version=0.51.0 user_agent= base_url= tenant= org= workspace= stream= consumer= cycles_completed=0 fetch_total=0 duration_ms=100 wait_ready_ms=0 wait_interval_ms=0 wait_require_health=false wait_ready_attempts=0 failed=true strict=false result=err exit_code=0",
		},
		{
			...
			strict:            false,
			version:           "0.51.0",
			want:              "SUMMARY version=0.51.0 user_agent= base_url= tenant= org= workspace= stream= consumer= cycles_completed=1 fetch_total=2 duration_ms=800 wait_ready_ms=2000 wait_interval_ms=250 wait_require_health=true wait_ready_attempts=5 failed=true strict=false result=err exit_code=0",
		},
		{
			...
			strict:            true,
			version:           "0.51.0",
			want:              "SUMMARY version=0.51.0 user_agent= base_url= tenant= org= workspace= stream= consumer= cycles_completed=2 fetch_total=4 duration_ms=600 wait_ready_ms=0 wait_interval_ms=0 wait_require_health=false wait_ready_attempts=0 failed=false strict=true result=ok exit_code=0",
		},
		{
			...
			strict:            true,
			version:           "0.51.0",
			want:              "SUMMARY version=0.51.0 user_agent= base_url= tenant= org= workspace= stream= consumer= cycles_completed=1 fetch_total=0 duration_ms=1500 wait_ready_ms=5000 wait_interval_ms=500 wait_require_health=true wait_ready_attempts=3 failed=true strict=true result=err exit_code=1",
		},
		{
			...
			strict:            false,
			version:           "9.9.9",
			want:              "SUMMARY version=9.9.9 user_agent= base_url= tenant= org= workspace= stream= consumer= cycles_completed=1 fetch_total=0 duration_ms=100 wait_ready_ms=0 wait_interval_ms=0 wait_require_health=false wait_ready_attempts=0 failed=false strict=false result=ok exit_code=0",
		},
		{
			...
			strict:            false,
			version:           "",
			want:              "SUMMARY version= user_agent= base_url= tenant= org= workspace= stream= consumer= cycles_completed=0 fetch_total=0 duration_ms=0 wait_ready_ms=0 wait_interval_ms=0 wait_require_health=false wait_ready_attempts=0 failed=false strict=false result=ok exit_code=0",
		},

		{
			...
			org:               "org_a",
			workspace:         "ws_1",
			want:              "SUMMARY version=0.54.0 user_agent= base_url= tenant=dept.research org=org_a workspace=ws_1 stream= consumer= cycles_completed=1 fetch_total=0 duration_ms=100 wait_ready_ms=0 wait_interval_ms=0 wait_require_health=false wait_ready_attempts=0 failed=false strict=false result=ok exit_code=0",
		},
		{
			...
			org:               "",
			workspace:         "",
			want:              "SUMMARY version=0.54.0 user_agent= base_url= tenant= org= workspace= stream= consumer= cycles_completed=0 fetch_total=0 duration_ms=0 wait_ready_ms=0 wait_interval_ms=0 wait_require_health=false wait_ready_attempts=0 failed=false strict=false result=ok exit_code=0",
		},
		{
		...
		},
		{
			...
			org:               "",
			workspace:         "",
			want:              "SUMMARY version=0.57.0 user_agent= base_url= tenant= org= workspace= stream= consumer= cycles_completed=0 fetch_total=0 duration_ms=0 wait_ready_ms=0 wait_interval_ms=0 wait_require_health=false wait_ready_attempts=0 failed=false strict=false result=ok exit_code=0",
		},
		{
		...
		},
		{
			...
			org:               "",
			workspace:         "",
			want:              "SUMMARY version=0.58.0 user_agent= base_url= tenant= org= workspace= stream= consumer= cycles_completed=0 fetch_total=0 duration_ms=0 wait_ready_ms=0 wait_interval_ms=0 wait_require_health=false wait_ready_attempts=0 failed=false strict=false result=ok exit_code=0",
		},
		{
			...
			want:              "SUMMARY version=0.60.0 user_agent=iomesh-client-sdk-go/0.60.0 base_url=http://127.0.0.1:8422 tenant=dept.research org=org_a workspace=ws_1 stream=EVENTS consumer=sdk-pull-loop cycles_completed=1 fetch_total=0 duration_ms=100 wait_ready_ms=0 wait_interval_ms=0 wait_require_health=false wait_ready_attempts=0 failed=false strict=false result=ok exit_code=0",
		},
		{
			...
			stream:            "",
			consumer:          "",
			want:              "SUMMARY version=0.60.0 user_agent= base_url= tenant= org= workspace= stream= consumer= cycles_completed=0 fetch_total=0 duration_ms=0 wait_ready_ms=0 wait_interval_ms=0 wait_require_health=false wait_ready_attempts=0 failed=false strict=false result=ok exit_code=0",
		},
	}
	for _, tc := range cases {
		tc := tc
		t.Run(tc.name, func(t *testing.T) {
			t.Parallel()
			got := formatPullLoopSummary(tc.cyclesCompleted, tc.fetchTotal, tc.durationMS, tc.waitReadyMS, tc.waitIntervalMS, tc.waitRequireHealth, tc.waitReadyAttempts, tc.failed, tc.strict, tc.version, tc.userAgent, tc.baseURL, tc.tenant, tc.org, tc.workspace, tc.stream, tc.consumer)
			if got != tc.want {
...
func TestFormatPullLoopSummaryAlwaysEmitsIdentity(t *testing.T) {
	...
	if !strings.Contains(got, "version=0.54.0 user_agent= base_url= tenant= org= workspace= stream= consumer= cycles_completed=") {
	...
	got2 := formatPullLoopSummary(1, 0, 10, 0, 0, false, 0, true, true, "0.54.0", "iomesh-client-sdk-go/0.54.0", "", "dept.x", "org_a", "ws_y", "", "")
...
func TestFormatPullLoopSummaryAlwaysEmitsUserAgent(t *testing.T) {
	...
	got := formatPullLoopSummary(0, 0, 0, 0, 0, false, 0, false, false, "0.57.0", "", "", "", "", "", "", "")
	...
	got2 := formatPullLoopSummary(1, 0, 10, 0, 0, false, 0, true, true, "0.57.0", ua, "", "dept.x", "org_a", "ws_y", "", "")
...
func TestFormatPullLoopSummaryAlwaysEmitsBaseURL(t *testing.T) {
	...
	got := formatPullLoopSummary(0, 0, 0, 0, 0, false, 0, false, false, "0.58.0", "", "", "", "", "", "", "")
	...
	got2 := formatPullLoopSummary(1, 0, 10, 0, 0, false, 0, true, true, "0.58.0", ua, base, "dept.x", "org_a", "ws_y", "", "")
...
func TestFormatPullLoopSummaryAlwaysEmitsStreamConsumer(t *testing.T) {
	...
	got := formatPullLoopSummary(0, 0, 0, 0, 0, false, 0, false, false, "0.60.0", "", "", "", "", "", "", "")
	for _, key := range []string{"stream=", "consumer="} {
		if !strings.Contains(got, key) {
			t.Fatalf("missing %s in %q", key, got)
		}
	}
	if !strings.Contains(got, "workspace= stream= consumer= cycles_completed=") {
	...
	base := "http://127.0.0.1:8422"
	got2 := formatPullLoopSummary(1, 0, 10, 0, 0, false, 0, true, true, "0.60.0", ua, base, "dept.x", "org_a", "ws_y", "EVENTS", "sdk-pull-loop")
	...
	if !strings.Contains(got2, "workspace=ws_y stream=EVENTS consumer=sdk-pull-loop cycles_completed=") {
...
func TestFormatPullLoopResult(t *testing.T) {
	...
	cases := []struct {
		...
		{name: "exit 0 success empty identity", exitCode: 0, failed: false, version: "0.52.0", want: "RESULT=done version=0.52.0 user_agent= base_url= tenant= org= workspace= stream= consumer= result=ok exit_code=0"},
		{name: "exit 1 strict failed empty identity", exitCode: 1, failed: true, version: "0.52.0", want: "RESULT=done version=0.52.0 user_agent= base_url= tenant= org= workspace= stream= consumer= result=err exit_code=1"},
		// same matrix as SUMMARY: scrapers pass the computed code; helper formats only
		{name: "non-strict failed still 0 result err", exitCode: 0, failed: true, version: "0.52.0", want: "RESULT=done version=0.52.0 user_agent= base_url= tenant= org= workspace= stream= consumer= result=err exit_code=0"},
		{name: "strict ok still 0 result ok", exitCode: 0, failed: false, version: "0.52.0", want: "RESULT=done version=0.52.0 user_agent= base_url= tenant= org= workspace= stream= consumer= result=ok exit_code=0"},
		{name: "custom version", exitCode: 0, failed: false, version: "9.9.9", want: "RESULT=done version=9.9.9 user_agent= base_url= tenant= org= workspace= stream= consumer= result=ok exit_code=0"},
		{name: "empty version still emits version=", exitCode: 0, failed: false, version: "", want: "RESULT=done version= user_agent= base_url= tenant= org= workspace= stream= consumer= result=ok exit_code=0"},
		{name: "empty version with exit 1", exitCode: 1, failed: true, version: "", want: "RESULT=done version= user_agent= base_url= tenant= org= workspace= stream= consumer= result=err exit_code=1"},
		{
			...
			want: "RESULT=done version=0.56.0 user_agent= base_url= tenant=dept.research org=org_a workspace=ws_1 stream= consumer= result=ok exit_code=0",
		},
		{
			name: "empty identity still emits tenant= org= workspace=", exitCode: 0, failed: false, version: "0.56.0",
			tenant: "", org: "", workspace: "",
			want: "RESULT=done version=0.56.0 user_agent= base_url= tenant= org= workspace= stream= consumer= result=ok exit_code=0",
		},
		{
			...
			want: "RESULT=done version=0.56.0 user_agent= base_url= tenant=dept.x org=org_a workspace=ws_y stream= consumer= result=err exit_code=1",
		},
		{
			name: "user_agent populated after version before tenant", exitCode: 0, failed: false, version: "0.57.0",
			userAgent: "iomesh-client-sdk-go/0.57.0",
			tenant:    "dept.research", org: "org_a", workspace: "ws_1",
			want: "RESULT=done version=0.57.0 user_agent=iomesh-client-sdk-go/0.57.0 base_url= tenant=dept.research org=org_a workspace=ws_1 stream= consumer= result=ok exit_code=0",
		},
		{
			name: "empty user_agent still emits user_agent=", exitCode: 0, failed: false, version: "0.57.0",
			userAgent: "", tenant: "", org: "", workspace: "",
			want: "RESULT=done version=0.57.0 user_agent= base_url= tenant= org= workspace= stream= consumer= result=ok exit_code=0",
		},
		{
			name: "populated user_agent with exit 1 does not invent success", exitCode: 1, failed: true, version: "0.57.0",
			userAgent: "iomesh-client-sdk-go/0.57.0",
			tenant:    "dept.x", org: "org_a", workspace: "ws_y",
			want: "RESULT=done version=0.57.0 user_agent=iomesh-client-sdk-go/0.57.0 base_url= tenant=dept.x org=org_a workspace=ws_y stream= consumer= result=err exit_code=1",
		},
		{
			...
			baseURL:   "http://127.0.0.1:8422",
			tenant:    "dept.research", org: "org_a", workspace: "ws_1",
			want: "RESULT=done version=0.58.0 user_agent=iomesh-client-sdk-go/0.58.0 base_url=http://127.0.0.1:8422 tenant=dept.research org=org_a workspace=ws_1 stream= consumer= result=ok exit_code=0",
		},
		{
			name: "empty base_url still emits base_url=", exitCode: 0, failed: false, version: "0.58.0",
			userAgent: "", baseURL: "", tenant: "", org: "", workspace: "",
			want: "RESULT=done version=0.58.0 user_agent= base_url= tenant= org= workspace= stream= consumer= result=ok exit_code=0",
		},
		{
			...
			baseURL:   "http://127.0.0.1:8422",
			tenant:    "dept.x", org: "org_a", workspace: "ws_y",
			want: "RESULT=done version=0.58.0 user_agent=iomesh-client-sdk-go/0.58.0 base_url=http://127.0.0.1:8422 tenant=dept.x org=org_a workspace=ws_y stream= consumer= result=err exit_code=1",
		},
		{
			...
			want: "RESULT=done version=0.60.0 user_agent=iomesh-client-sdk-go/0.60.0 base_url=http://127.0.0.1:8422 tenant=dept.research org=org_a workspace=ws_1 stream=EVENTS consumer=sdk-pull-loop result=ok exit_code=0",
		},
		{
			...
			want: "RESULT=done version=0.60.0 user_agent= base_url= tenant= org= workspace= stream= consumer= result=ok exit_code=0",
		},
		{
			...
			want: "RESULT=done version=0.60.0 user_agent=iomesh-client-sdk-go/0.60.0 base_url=http://127.0.0.1:8422 tenant=dept.x org=org_a workspace=ws_y stream=ORDERS consumer=pull-worker result=err exit_code=1",
		},
	}
	for _, tc := range cases {
		tc := tc
		t.Run(tc.name, func(t *testing.T) {
			t.Parallel()
			got := formatPullLoopResult(tc.exitCode, tc.failed, tc.version, tc.userAgent, tc.baseURL, tc.tenant, tc.org, tc.workspace, tc.stream, tc.consumer)
			if got != tc.want {
			...
			for _, key := range []string{"user_agent=", "base_url=", "tenant=", "org=", "workspace=", "stream=", "consumer=", "result=", "exit_code="} {
				if !strings.Contains(got, key) {
...
func TestFormatPullLoopResultAlwaysEmitsIdentity(t *testing.T) {
	t.Parallel()
	// Empty identity still emits keys (honest empty strings).
	got := formatPullLoopResult(0, false, "0.56.0", "", "", "", "", "", "", "")
	for _, key := range []string{"tenant=", "org=", "workspace="} {
		if !strings.Contains(got, key) {
			t.Fatalf("missing %s in %q", key, got)
		}
	}
	if !strings.Contains(got, "version=0.56.0 user_agent= base_url= tenant= org= workspace= stream= consumer= result=ok exit_code=") {
		t.Fatalf("identity order want after version/user_agent/base_url: %q", got)
	}
	// Populated identity passes through; does not invent readiness / exit success.
	got2 := formatPullLoopResult(1, true, "0.56.0", "iomesh-client-sdk-go/0.56.0", "", "dept.x", "org_a", "ws_y", "", "")
	if !strings.Contains(got2, "tenant=dept.x") || !strings.Contains(got2, "org=org_a") || !strings.Contains(got2, "workspace=ws_y") {
		t.Fatalf("populated identity missing: %q", got2)
	}
...
func TestFormatPullLoopResultAlwaysEmitsUserAgent(t *testing.T) {
	t.Parallel()
	// Empty user_agent still emits key (honest empty string).
	got := formatPullLoopResult(0, false, "0.57.0", "", "", "", "", "", "", "")
	if !strings.Contains(got, "user_agent=") {
		t.Fatalf("missing user_agent= in %q", got)
	}
	if !strings.Contains(got, "version=0.57.0 user_agent= base_url= tenant=") {
	...
	// Package-default UA passes through; does not invent readiness / exit success.
	ua := "iomesh-client-sdk-go/0.57.0"
	got2 := formatPullLoopResult(1, true, "0.57.0", ua, "", "dept.x", "org_a", "ws_y", "", "")
	if !strings.Contains(got2, "user_agent="+ua) {
		t.Fatalf("populated user_agent missing: %q", got2)
	}
	if !strings.Contains(got2, "version=0.57.0 user_agent="+ua+" base_url= tenant=dept.x") {
...
func TestFormatPullLoopResultAlwaysEmitsBaseURL(t *testing.T) {
	t.Parallel()
	// Empty base_url still emits key (honest empty string).
	got := formatPullLoopResult(0, false, "0.58.0", "", "", "", "", "", "", "")
	if !strings.Contains(got, "base_url=") {
		t.Fatalf("missing base_url= in %q", got)
	}
	if !strings.Contains(got, "version=0.58.0 user_agent= base_url= tenant=") {
	...
	ua := "iomesh-client-sdk-go/0.58.0"
	base := "http://127.0.0.1:8422"
	got2 := formatPullLoopResult(1, true, "0.58.0", ua, base, "dept.x", "org_a", "ws_y", "", "")
	if !strings.Contains(got2, "base_url="+base) {
		t.Fatalf("populated base_url missing: %q", got2)
	}
	if !strings.Contains(got2, "version=0.58.0 user_agent="+ua+" base_url="+base+" tenant=dept.x") {
...
func TestFormatPullLoopResultAlwaysEmitsStreamConsumer(t *testing.T) {
	t.Parallel()
	// Empty stream/consumer still emit keys (honest empty strings).
	got := formatPullLoopResult(0, false, "0.60.0", "", "", "", "", "", "", "")
	for _, key := range []string{"stream=", "consumer="} {
		if !strings.Contains(got, key) {
			t.Fatalf("missing %s in %q", key, got)
		}
	}
	if !strings.Contains(got, "workspace= stream= consumer= result=ok exit_code=") {
		t.Fatalf("stream/consumer order want after workspace before result: %q", got)
	}
	// Connect config passes through; does not invent readiness / exit success.
	ua := "iomesh-client-sdk-go/0.60.0"
	base := "http://127.0.0.1:8422"
	got2 := formatPullLoopResult(1, true, "0.60.0", ua, base, "dept.x", "org_a", "ws_y", "EVENTS", "sdk-pull-loop")
	if !strings.Contains(got2, "stream=EVENTS") || !strings.Contains(got2, "consumer=sdk-pull-loop") {
		t.Fatalf("populated stream/consumer missing: %q", got2)
	}
	if !strings.Contains(got2, "workspace=ws_y stream=EVENTS consumer=sdk-pull-loop result=err exit_code=1") {
...
func TestFormatPullLoopResultExitCodeMatrix(t *testing.T) {
	...
	cases := []struct {
		...
		{name: "ok non-strict", failed: false, strict: false, want: "RESULT=done version=0.52.0 user_agent=iomesh-client-sdk-go/0.52.0 base_url= tenant= org= workspace= stream= consumer= result=ok exit_code=0"},
		{name: "failed non-strict", failed: true, strict: false, want: "RESULT=done version=0.52.0 user_agent=iomesh-client-sdk-go/0.52.0 base_url= tenant= org= workspace= stream= consumer= result=err exit_code=0"},
		{name: "ok strict", failed: false, strict: true, want: "RESULT=done version=0.52.0 user_agent=iomesh-client-sdk-go/0.52.0 base_url= tenant= org= workspace= stream= consumer= result=ok exit_code=0"},
		{name: "failed strict", failed: true, strict: true, want: "RESULT=done version=0.52.0 user_agent=iomesh-client-sdk-go/0.52.0 base_url= tenant= org= workspace= stream= consumer= result=err exit_code=1"},
	}
	for _, tc := range cases {
		tc := tc
		t.Run(tc.name, func(t *testing.T) {
			...
			got := formatPullLoopResult(exitCode, tc.failed, ver, ua, "", "", "", "", "", "")
			if got != tc.want {
...
func TestFormatPullLoopSummaryAlwaysEmitsResult(t *testing.T) {
	t.Parallel()
	ok := formatPullLoopSummary(0, 0, 0, 0, 0, false, 0, false, false, "0.59.0", "", "", "", "", "", "", "")
	...
	errLine := formatPullLoopSummary(1, 0, 10, 0, 0, false, 0, true, false, "0.59.0", "", "", "", "", "", "", "")
	...
	strictErr := formatPullLoopSummary(1, 0, 10, 0, 0, false, 0, true, true, "0.59.0", "", "", "", "", "", "", "")
...
func TestFormatPullLoopResultAlwaysEmitsResult(t *testing.T) {
	t.Parallel()
	ok := formatPullLoopResult(0, false, "0.59.0", "", "", "", "", "", "", "")
	if !strings.Contains(ok, "workspace= stream= consumer= result=ok exit_code=0") {
		t.Fatalf("want result=ok before exit_code: %q", ok)
	}
	// Non-strict failed: exit_code=0 but result=err (honest hard-fail flag).
	errLine := formatPullLoopResult(0, true, "0.59.0", "", "", "", "", "", "", "")
	if !strings.Contains(errLine, "workspace= stream= consumer= result=err exit_code=0") {
		t.Fatalf("want result=err when failed (non-strict exit 0): %q", errLine)
	}
	strictErr := formatPullLoopResult(1, true, "0.59.0", "", "", "", "", "", "", "")
	if !strings.Contains(strictErr, "workspace= stream= consumer= result=err exit_code=1") {
		t.Fatalf("want result=err when failed strict: %q", strictErr)
	}
}
